...
| 陈晓瑜/章天毅 (决策) | 全系统各节点 <br> **(含仿真组郑经纬/罗京京)** | `/system/current_state` | `std_msgs/msg/String` | **系统广播**：任务阶段六态（SEARCHING / TARGET_FOUND / APPROACHING / BRUSHING / RETURNING / ERROR）；仅决策层(FSM)发布，飞控层经 `/uav/flight_fault` 上报故障 |
